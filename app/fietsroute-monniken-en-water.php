<?php include "layout/head.php" ?>
    <section id="single-routes">
        <div class="container-fluid single-routes">
            <img src="assets/img/fietsroutes/monniken.jpg">
            <div class="container single-fietsroutes py-5">
                <div class="row">
                    <div class="col-12 text-center">
                        <h1 class="main-title">FIETSROUTE MONNIKEN EN WATER</h1>
                        <p>
            ...
            <iframe src="assets/img/fietsroutes/Kaart%20Monniken%20en%20water_kleur.pdf" frameborder="0"></iframe>
        </div>
    </section>
